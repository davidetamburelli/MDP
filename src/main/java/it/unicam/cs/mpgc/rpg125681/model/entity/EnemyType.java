...
public enum EnemyType {
    ...
    GOBLIN("Goblin", 18, 6, 10, BehaviorKind.MELEE, 0, AbsorbStat.ATTACK, 1, 0.30),
    SKELETON("Skeleton", 28, 8, 14, BehaviorKind.MELEE, 0, AbsorbStat.MAX_HP, 6, 0.15),
    ARCHER("Archer", 16, 7, 16, BehaviorKind.RANGED, 3, AbsorbStat.ATTACK, 2, 0.20),
    MAGE("Mage", 14, 11, 22, BehaviorKind.RANGED, 4, AbsorbStat.ATTACK, 3, 0.25);
    ...
    EnemyType(String displayName, int baseHp, int baseAttack, int baseExp,
              BehaviorKind behaviorKind, int range, AbsorbStat absorbStat, int absorbAmount, double dropChance) {
